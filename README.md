...
## Tampilan Aplikasi :
## Penjelasan Halaman Note App (Light Mode) 
Aplikasi Note App merupakan aplikasi pencatat sederhana berbasis Flutter yang digunakan untuk menyimpan dan mengelola catatan harian secara digital menggunakan database SQLite.

<img width="431" height="842" alt="Screenshot 2026-05-13 092204" src="https://github.com/user-attachments/assets/d7500f0f-9fc5-4549-b95e-ab2bcb613bf8" />

## Penjelasan Halaman Note App (dark Mode )
Aplikasi Note App merupakan aplikasi pencatat sederhana berbasis Flutter yang digunakan untuk menyimpan dan mengelola catatan harian secara digital menggunakan database SQLite.
